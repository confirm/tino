...
The instance-wide accent colour is configured by the administrator via the :attr:`TINO_ACCENT_COLOUR <tino.config.TINO_ACCENT_COLOUR>` environment variable.
